...
import type { ICanvasEnvironmentProps, IWindowEnvironmentProps } from '@wixc3/simulation-core';
import type { SetupSimulationStage, RenderSimulation, SimulationToJsx } from './types';
